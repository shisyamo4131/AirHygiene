...
import GInputIndustrialContract from '../inputs/GInputIndustrialContract.vue'
...
export default {
  components: {
    ...
    GDialogEditor,
    AIconRegist,
    GInputIndustrialContract,
  },
  props: {
    siteId: { type: String, required: true },
    label: { type: String, default: '産業廃棄物契約', required: false },
    dialogProps: {
      type: Object,
    ...
    <template #default="{ dialog, table, model, search }">
      <v-toolbar dense flat>
        ...
        <g-dialog-editor v-bind="dialog.attrs" v-on="dialog.on">
          ...
          <template #form>
            <g-input-industrial-contract v-bind="model.attrs" v-on="model.on" />
          </template>
        </g-dialog-editor>
      </v-toolbar>
